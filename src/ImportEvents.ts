...
import {CamerasBasisEvents} from './libs/device/event/CamerasEvent'
...
export const ImportEvent = (workerContext: WorkerContext) => {
    ...
    workerContext.transformers.addEventTransformer(CamerasBasisEvents.DEVICE_CAMERAS_TRANSFORMER_NAME, new CamerasBasisEvents.CamerasEventTransformer());
